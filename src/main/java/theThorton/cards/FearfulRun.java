...
public class FearfulRun extends AbstractThortonCard {

    public static final String ID = ThortMod.makeID("FearfulRun");
    public static final String IMG = makeCardPath("FearfulRun.png");
    ...
    public FearfulRun() {
        ...
        ThortMod.loadJokeCardImage(this, makeBetaCardPath("FearfulRun.png"));
        baseBlock = BLOCK;
    }
