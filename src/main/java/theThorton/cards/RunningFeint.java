...
public class RunningFeint extends AbstractThortonCard {

    public static final String ID = ThortMod.makeID("RunningFeint");
    public static final String IMG = makeCardPath("RunningFeint.png");
    ...
    public RunningFeint() {
        ...
        ThortMod.loadJokeCardImage(this, makeBetaCardPath("RunningFeint.png"));
