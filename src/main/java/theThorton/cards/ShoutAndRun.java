...
public class ShoutAndRun extends AbstractThortonCard {

    public static final String ID = ThortMod.makeID("ShoutAndRun");
    public static final String IMG = makeCardPath("ShoutAndRun.png");
    ...
    public ShoutAndRun() {
        ...
        ThortMod.loadJokeCardImage(this, makeBetaCardPath("ShoutAndRun.png"));
