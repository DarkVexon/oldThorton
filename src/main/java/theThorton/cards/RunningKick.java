...
public class RunningKick extends AbstractThortonCard {

    public static final String ID = ThortMod.makeID("RunningKick");
    public static final String IMG = makeCardPath("RunningKick.png");
    ...
    public RunningKick() {
        ...
        ThortMod.loadJokeCardImage(this, makeBetaCardPath("RunningKick.png"));
        baseDamage = DAMAGE;
    }
