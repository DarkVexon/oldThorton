...
public class Strike extends AbstractThortonCard {

    public static final String ID = ThortMod.makeID("Strike");
    ...
    public Strike() {
        ...
        ThortMod.loadJokeCardImage(this, makeBetaCardPath("Strike.png"));
        baseDamage = DAMAGE;
