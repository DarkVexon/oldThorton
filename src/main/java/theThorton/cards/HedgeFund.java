...
import theThorton.powers.DrawReductionPowerPlus;

import static theThorton.ThortMod.makeBetaCardPath;
import static theThorton.ThortMod.makeCardPath;


public class HedgeFund extends AbstractThortonCard {

    public static final String ID = ThortMod.makeID("HedgeFund");
    ...
    public HedgeFund() {
        ...
        ThortMod.loadJokeCardImage(this, makeBetaCardPath("HedgeFund.png"));
        baseDamage = DAMAGE;
    }
