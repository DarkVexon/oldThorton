...
public class Heckle extends AbstractThortonCard {

    public static final String ID = ThortMod.makeID("Heckle");
    public static final String IMG = makeCardPath("Heckle.png");
    ...
    public Heckle() {
        ...
        ThortMod.loadJokeCardImage(this, makeBetaCardPath("Heckle.png"));
