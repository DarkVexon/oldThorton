...
public class HitAhead extends AbstractThortonCard {

    public static final String ID = ThortMod.makeID("HitAhead");
    public static final String IMG = makeCardPath("HitAhead.png");
    ...
    public HitAhead() {
        ...
        ThortMod.loadJokeCardImage(this, makeBetaCardPath("HitAhead.png"));
        baseDamage = DAMAGE;
    }
