...
import theThorton.cards.Nibble;

import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

public class VampiresThortonEvent extends AbstractImageEvent {
    public static final String ID = "thorton:Vampires";
    ...
    public VampiresThortonEvent() {
        ...
        this.imageEventText.setDialogOption("[Accept] #gRemove #gall Strikes. #gReceive #g5 Nibbles. #rLose #r" + HP_DRAIN_PERCENT + OPTIONS[1], new Nibble());
        if (this.hasVial) {
            String vialName = (new BloodVial()).name;
            this.imageEventText.setDialogOption(OPTIONS[3] + vialName + "] #gRemove #gall Strikes. #gReceive #g5 Nibbles.", new Nibble());
        }
